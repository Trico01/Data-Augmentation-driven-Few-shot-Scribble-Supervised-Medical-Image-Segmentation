...
def get_args_parser():
    ...
    # parser.add_argument('--output_dir', default='/data/zhangke/experiments_resume/MSCMR_puzzlemix/',
                        # help='path where to save, empty for no saving')
    parser.add_argument('--output_dir', default='/data4/zhangke/experiments_resume/MSCMR_puzzlemix_5/',
                        help='path where to save, empty for no saving')
